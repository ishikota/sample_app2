...
describe User do
  ...
  describe "micropost associations" do
    ...
    it "should the right micropost in the right order" do
      expect(@user.microposts.to_a).to eq [newer_micropost, older_micropost]
    end

    it "should be destroyed when host user was deleted" do
      microposts = @user.microposts.to_a  # create deep copy
      @user.destroy
